...
function readProducts(products) {
  ...
  products.forEach((product, position) => {
    ...
    <div class="card" style="background-image:url(${product.img})" alt="${product.title}" class= "w-100">
        ...
        <input type="number" class="form-control" value=1 min=1 id="addToCart${position}">
            ...
            <button type="button" class="btn btn-primary " onclick="addToCart(${position})">ADD TO CART</button>
          ...
          <div class=" d-flex justify-content-end card-footer">
            ...
            <button type="button" class="btn btn-dark w-50 ms-3" onclick="deleteProduct(${position})" >
